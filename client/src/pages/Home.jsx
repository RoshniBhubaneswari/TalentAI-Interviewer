    ...
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-4 rounded-full flex items-center gap-2'>
          ...
          <div className='text-center mb-28'>
              ...
              className='text-4xl md:text-6xl font-semibold leadind-tight max-w-4xl mx-auto mb-3'>
                Practice Interviews with
                <span className='relative inline-block py-8'>
              ...
              <div className='flex flex-wrap justify-center gap-4 mt-10'>
                ...
                onClick={()=>{
                  ...
                  className='bg-black text-white py-3 px-10 rounded-full hover:opacity-90 transition shadow-md'>
                  Start Interview
                </motion.button>
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  [
                    ...
                    },
                    {
                      ...
                      desc:"Detailed strengths, weaknesses and improvement suggestions."
                    },
                    {
                      image:analyticsImg,
                      icon:<BsBarChart size={20}/>,
                      title:"History & Analytics",
                      desc:"Track progrss with performance graphs and topic analysis."
                    }
                  ].map((item,index)=>(
                    <motion.div key={index} 
                    initial={{opacity:0,y:30}}
