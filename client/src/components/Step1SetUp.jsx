  ...
  const handleStart=async()=>{
    ...
    try{
      const result=await axios.post(ServerUrl + "/api/interview/generate-questions",
        {experience,mode,resumeText, projects, skills},{withCredentials:true})
      console.log(result.data);
      if(userData){
    ...
    className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4'>
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        className='relative bg-gradient-to-br from-green-50 to-green-100 p-12 flex flex-col justify-center'> 
          <h2 className='text-4xl font-bold mb-6 text-gray-800'>Start Your AI Interview</h2>
          ...
          <div className='space-y-5'>
            {
              [
                {
                  icon:<FaUserTie
                  className='text-green-600 text-xl'></FaUserTie>,
                  text:"Choose Role & Experience",
                },
                {
                  icon:<FaMicrophoneAlt
                  className='text-green-600 text-xl'></FaMicrophoneAlt>,
                  text:"Smart Voice Interview",
                },
                {
                  icon:<FaChartLine
                  className='text-green-600 text-xl'></FaChartLine>,
        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            ...
            <div className='relative'>
              ...
              <input type='text' placeholder='Experience (e.g. 2years)' 
              className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
            ...
            <motion.button 
              ...
              whileHover={{scale:1.03}}
              whileTap={{scale:0.95}}
              className='w-full disabled:bg-gray-600 bg-green-600 text-white py-3 rounded-full text-lg font-semibold duration-300 shadow-md'>
