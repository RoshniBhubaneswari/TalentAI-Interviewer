...
function Step2Interview({ interviewData, onFinish }) {
    ...
    useEffect(()=>{
        const loadVoices=()=>{
            ...
            const femaleVoice=
               voices.find(v=>
                v.name.toLowerCase().includes("zaira") ||
    ...
    useEffect(()=>{
        ...
        const runIntro=async()=>{
            if(isIntroPhase){
                await speakTest(
                    `Hello ${userName}, it's great to meet you today. I hope you're feeling confident and ready.`
                );

                await speakTest(
                    "I will be asking you a series of questions. Just answer naturally, and take your time. Let's get started."
                );
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
            <div className='w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
                ...
                <div className='w-full max-w-md rounded-2xl overflpw-hidden shadow-xl'>
                    <video 
                    src={femaleVideo}
                    key={videoSource}
                    ref={videoRef}
                ...
                <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
                    ...
                    {!isIntroPhase && (<div className='relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm'>
                        <p className='text-sm sm:text-sm text-gray-400 mb-2'>{currentIndex + 1} of {questions.length}</p>
                    ...
                    value={answer}
                    className='flex-1 bg-gray-100 p-4 sm:p-6 rounded-2xl resize-none outline-none border border-gray-200 focus:ring-2 focu:ring-emerald-500 transition text-gray-800'/>
                    ...
                    {!feedback ? (<div className='flex items-center gap-4 mt-6'>
                        ...
                        whileTap={{scale:0.95}}
                        className='flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
