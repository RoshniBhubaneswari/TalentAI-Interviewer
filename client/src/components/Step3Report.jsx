...
function Step1SetUp({report}) {
    ...
    if(finalScore>=8){
        ...
        performanceText="Good, but room for improvement.";
        shortTagline="Decent communication, but work on clarity.";
    }
    else{
        performanceText="Needs significant improvement.";
        shortTagline="Focus on clear and structured communication.";
    }
    ...
    const downloadPDF=()=>{
        ...
        autoTable(doc,{
            ...
            columnStyles:{
                ...
                2:{cellWidth: 20, haligan:"center"}, //score
                ...
                <div className='md:mb-10 w-full flex items-start gap-4'>
                    ...
                    <div>
                        ...
                        <p className='text-gray-500 mt-2'>
                            AI-powered performance insights to boost your interview skills
                        </p>
                    </div>
                            ...
                            {questionWiseScore.map((q,i)=>(
                                <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                                    ...
                                    <div className='bg-green-50 border-green-200 p-4 rounded-lg'>
                                        <p className='text-sm text-green-600 font-semibold mb-1'>AI Feedback</p>
